...
class Config(object):
    ...
    def __init__(self):
        ...
        root_dir = ''   # /home/wzj_2080/code_server/wzj_multi_view_graph_batch/
        ...
        self.save_path = root_dir + 'Dataset/' + self.dataset + '/' + self.dataset + '.result' + '.ckpt'  # 模型训练结果

        self.is_raw_text = False

        self.return_text_representation = True
        self.text_representation_save_path = root_dir + 'Dataset/' + self.dataset + '/' + self.dataset + '.result'
        ...
        self.each_word_out_degree_dis = 50
        self.each_word_out_degree_pmi = 50
        self.each_word_out_degree_top = 50

        self.PMI_windows_size = 15
